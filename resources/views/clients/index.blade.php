        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="py-6 overflow-hidden bg-white shadow-sm sm:rounded-lg ">
                ...
                <table class="w-full mx-auto divide-y table-auto">
                    <thead>
                        <tr>
                            <th class="px-8 py-4 text-lg text-left sm:px-10">Company </th>
                            <th class="px-8 py-4 text-lg text-left sm:px-10">Telephone </i></th>
                            <th class="hidden px-8 py-4 text-lg text-left sm:px-10 lg:table-cell">Email </i></th>
                        </tr>
                    </thead>
                            ...
                            <tr class="font-light text-violet-950">
                                <td class="table-cell px-8 py-2 sm:px-10">
                                    <a href="{{ route('clients.show', [$client->id]) }}"
                                        class="hover:underline">{{ $client->company }}</a>
                                </td>

                                <td class="table-cell px-8 py-2 sm:px-10">
                                    <a href="{{ route('clients.show', [$client->id]) }}">{{ $client->telephone }}</a>
                                </td>
